<template>
	<div class="daily">
		<div class="daily-menu">
			...
			<div class="daily-menu-item" :class="{ on: type === 'recommend' }" @click="handleToYesterday">昨日新闻</div>
			<div class="daily-menu-item" :class="{ on: type === 'recommend' }" @click="handleToBefore">往期新闻</div>
			<div class="daily-menu-item">
				<input type="date" @change="handleDate()" v-model="chooseDate">
			</div>
	...
	export default {
		...
		methods: {
			...
			handleToYesterday() {
				this.type = 'recommend';
				this.recommendList = [];
				this.dailyTime = $.getYesterdayTime();
				this.getRecommendList();
			},
			handleToBefore() {
			...
			handleDate() {
				const chooseday = new Date(this.chooseDate);
				this.type = 'recommend';
				this.recommendList = [];
				this.dailyTime = chooseday.getTime();
				this.getRecommendList();
			}
		},
		mounted() {
